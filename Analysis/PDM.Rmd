...
```{r eval=T, echo=T, fig.heigt=3.5, dev='pdf', fig.path='../Manuscript/Figures/BRTaccuracy.pdf', dpi=300}
...
plot(1:4, brt.meanAUC, ylim=c(0.45, 1), xlim=c(0.7,4.3), las=1, pch=16, tck=0.01, xaxt='n', xlab='Predictive model used', ylab='Area Under ROC curve')

abline(h=0.5, col=grey(0.5), lty=2, lwd=2)
abline(v=3.5, col=grey(0.8), lwd=1.5)
segments(x0=1:4, y0=brt.meanAUC + (brt.sd), y1=brt.meanAUC - (brt.sd), col=grey(0.8),lwd=2)
...
```{r eval=TRUE, echo=TRUE, fig.width=6, fig.height=6, dev='pdf', fig.path='../Manuscript/Figures/parAccuracy.pdf', dpi=300}
layout(matrix(c(1,2,3,4), ncol=2), heights=c(1,1.5))

hostCol=c('#9367B1', '#20C0D0','#719240', grey(0.5), '#D9437E')
par(mar=c(1,4,2,0.25))
plot(as.factor(parType[,1]), testRet[1:238,3], col=hostCol, pch=16, las=1, ylab='Accuracy (AUC)', xaxt='n', ylim=c(0.25,1), main="Host traits")

par(mar=c(8,4,2,0.25))
plot(as.factor(parType[,1]), testRetgeo[1:238,3], col=hostCol, pch=16, las=1, ylab='Accuracy (AUC)', xaxt='n', ylim=c(0.25,1), main="Geography")
parGroups=c('Acanthocephala', 'Cestoda', 'Monogenea', 'Nematoda', 'Trematoda')
axis(1, 1:5, parGroups, las=2, tck=0.01, padj=0)

par(mar=c(1,4,2,0.25))
plot(as.factor(parType[,1]), testRetb[1:238,3], col=hostCol, pch=16, las=1, ylab='', xaxt='n', ylim=c(0.25,1), main="Parasite community")

par(mar=c(8,4,2,0.25))
plot(as.factor(parType[,1]), testRetc[1:238,3], col=hostCol, pch=16, las=1, ylab='', xaxt='n', ylim=c(0.25,1), main="All")
parGroups=c('Acanthocephala', 'Cestoda', 'Monogenea', 'Nematoda', 'Trematoda')
axis(1, 1:5, parGroups, las=2, tck=0.01, padj=0)
...
```{r eval=T, echo=T, dev='pdf', fig.path='../Manuscript/Figures/hostTraits.pdf', dpi=300}
...
```{r eval=T, echo=T, fig.width=9, dev='pdf', fig.path='../Manuscript/Figures/hostTraitsColor.pdf', dpi=300}
...
```{r eval=T, echo=T, dev='pdf', fig.path='../Manuscript/Figures/geography.pdf', dpi=300}
varNames=c('Geographic region', 'Area of occupancy', 'Latitude', 'Max length', 'Host trophic level', 'Longitude', 'Host age at maturity', 'Host life span', 'Host growth rate', 'Marine', 'Freshwater', 'Brackish')
...
```{r eval=T, echo=T, fig.width=9, dev='pdf', fig.path='../Manuscript/Figures/geographyColor.pdf', dpi=300}
layout(matrix(c(1,2),ncol=1), heights=c(1.5, 1))
par(mar=c(0.25,0.25,0.25,0.25))
...
```{r eval=T, echo=T, dev='pdf', fig.path='../Manuscript/Figures/parasiteCommunity.pdf', dpi=300}
...
```{r eval=T, echo=T, fig.width=9, dev='pdf', fig.path='../Manuscript/Figures/parasiteCommunityColor.pdf', dpi=300}
...
```{r eval=T, echo=T, fig.height=6, dev='pdf', fig.path='../Manuscript/Figures/allData.pdf', dpi=300}
...
par(mar=c(3,9,1,1))
plot(brtMean.c[inds], 1:18, pch=16, xlim=c(0,18), ylim=c(0.75,18.25), las=1, xlab='', ylab='', yaxt='n', col=1, tck=0.01)
segments(x0=brtMean.c[inds] - brtSE.c[inds], x1=brtMean.c[inds] + brtSE.c[inds], y0=1:18, col=grey(0.5, alpha=0.5),lwd=3)
mtext("Relative contribution", side=1, line=2)
axis(2, at=1:18, labels=c('Brackish', 'Marine', 'Freshwater', 'Host growth rate', 'Lifespan', 'Host age at maturity', 'PSR', 'Longitude', 'Area of occupancy', 'Max length', 'Latitude', 'Host trophic level', 'PCA1', 'PCA4', 'PCA5', 'PCA2', 'Geographic region', 'PCA3'),las=1)
```


```{r eval=T, echo=T, fig.width=9, dev='pdf', fig.path='../Manuscript/Figures/allDataColor.pdf', dpi=300}
layout(matrix(c(1,2),ncol=1), heights=c(2.5, 1))
par(mar=c(0.25,0.25,0.25,0.25))
...
```{r fig.width=10, dev='pdf', fig.path='../Manuscript/Figures/parTypeColor.pdf', dpi=300}
layout(matrix(c(1,2),ncol=1), heights=c(1.5, 1))
par(mar=c(0.25,0.25,0.25,0.25))
